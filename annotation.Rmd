...
|-------------|--------|------------------------------|-----------------------------------------------------|
| **[ʎ]**     | L |**Palatal lateral approximant**: reduced intensity relative to vowels; weak formants; no strong frication  | ![](Sample_sounds/Palatal_lateral_approximant.ogg)  |
| **[lj]**| lj | **Lateral followed by glide**: two phase structure; early vowel/glide; bi-phasic intensity contour     | ---                                                    |
|**[j]**| j | **Palatal approximant**: glide; strong formants; intensity similar to vowels; flat intensity          | ![](Sample_sounds/Palatal_approximant.ogg)          |
| **[l]** | l | **Alveolar lateral approximant**: no palatal cues; alveolar like formants; mid-level intensity | ![](Sample_sounds/Alveolar_lateral_approximant.ogg) |
| **[ʃ]** | S | **Voiceless palato-alv sibilant**: audible frication; little or no formant; intensity may be high   | ![](Sample_sounds/Voiceless_palato-alveolar_sibilant.ogg)                           |
| **[ʒ]** | Z | **Voiced palato-alv sibilant**: audible frication; voice bar; little or no formant; intensity may be high   | ![](Sample_sounds/Voiced_palato-alveolar_sibilant.ogg)                           |
...
This tier will have boundaries for the onset and offset of the word. The word segment will be labelled with the *target* word as it appears in the [word list](word_list.pdf). This is the *predicted pronunciation* of the Portuñol target. Please stick to the spelling of this Portuñol target and NOT the realization that the speaker actually produces. For example, a speaker might produce the word "mujerengo" as [muʃerego], but the word tier should say "mujerengo."
...
![](images/RH1_mujerona_deletion.png)\

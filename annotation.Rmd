...
|-------------|------------------------------|-----------------------------------------------------|
| **[ʎ]**         | palatal lateral approximant  | ![](Sample_sounds/Palatal_lateral_approximant.ogg)  |
| **[lj]**        | lateral followed by glide    | ---                                                    |
|**[j]**        | palatal approximant          | ![](Sample_sounds/Palatal_approximant.ogg)          |
| **[l]**         | alveolar lateral approximant | ![](Sample_sounds/Alveolar_lateral_approximant.ogg) |
| **[ʒ]**         | voiced palato-alv sibilant   | ![](Sample_sounds/Voiced_palato-alveolar_sibilant.ogg)                           |
| **0**           | deletion                     | ---                                                    |
